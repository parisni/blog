...
# parisni speaking build configuration file, created by
# `ablog start` on Thu May 10 00:08:03 2018.
#
...
blog_title = u'parisni speaking Blog'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'http://natus.fgh.ovh/blog/'
...
blog_authors = {
    'nicolas paris': ('nicolas paris', None),
}
...
project = u'silex blog'
copyright = u'2018, nicolas paris'
author = u'nicolas paris'
...
htmlhelp_basename = 'parisnispeakingdoc'
